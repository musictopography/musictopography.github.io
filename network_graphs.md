...
<div class="graphs-grid">
  ...
  <div class="graph-card">
    ...
    <p>
      This visualisation represents all instances in which two performers took part in the same
      musical event, as well as all instances in which a performer performed the music of a given composer.
      It consists of 2,466 nodes and 11,423 unique edges, with a total weight of 52,282 effective relationships.
      The topology of the network reflects the relationships between the different musical worlds that made up
      the Milanese ecosystem.
    </p>
    ...
    <a class="graph-preview" href="https://raw.githubusercontent.com/martinnicastro/martinnicastro.github.io/64c0bc2a31d2ebe7fd8d3c86de1fefafb6284e68/modularity.svg" target="_blank" rel="noopener noreferrer">
      <img src="{{ '/images/graphs/modularity_preview.png' | relative_url }}" alt="Preview of the Performers and Composers network graph">
    </a>
  ...
  <div class="graph-card">
    ...
    <p>
      This graph connects Milanese music venues with the performers who appeared there between 1958 and 1962.
      It includes 1,985 nodes connected by 2,517 individual edges. Each edge is weighted according to the number
      of appearances at a venue, resulting in 18,371 effective ties. The colours of both nodes and edges reflect
      venue categories and reveal the indirect emergence of musical genres.
    </p>
    ...
    <a class="graph-preview" href="https://raw.githubusercontent.com/musictopography/musictopography.github.io/1985207c7729d63a6fc610d7962af9496443b931/spazi_musicisti_nomi.svg" target="_blank" rel="noopener noreferrer">
      <img src="{{ '/images/graphs/spazi_musicisti_nomi_preview.png' | relative_url }}" alt="Preview of the Performers and Venues graph">
    </a>
  ...
  <div class="graph-card">
    ...
    <p>
      This network relates performance spaces to musical genres. It features 122 nodes, divided into 99 venues
      and 23 musical genres, and 309 weighted edges, amounting in total to 11,434 relationships. The topology
      of the graph offers a different perspective on the relationship between spatial dimension and genre.
    </p>
    ...
    <a class="graph-preview" href="https://raw.githubusercontent.com/musictopography/musictopography.github.io/14d4d07b1e5c1b46db9ab25eb276252d07f0ab75/images/generi_spazi.svg" target="_blank" rel="noopener noreferrer">
      <img src="{{ '/images/graphs/generi_spazi_preview.png' | relative_url }}" alt="Preview of the Venues and Music Genres graph">
    </a>
